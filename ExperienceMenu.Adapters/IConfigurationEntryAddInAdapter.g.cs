...
namespace ExperienceMenu.Adapters
{
    ...
    {
        internal static ExperienceMenu.Views.IConfigurationEntry ContractToViewAdapter(Start9.Api.Contracts.IConfigurationEntryContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IConfigurationEntryContract ViewToContractAdapter(ExperienceMenu.Views.IConfigurationEntry view)
        {
            if ((view == null))
            {
                return null;
