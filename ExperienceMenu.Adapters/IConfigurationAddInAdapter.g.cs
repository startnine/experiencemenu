...
namespace ExperienceMenu.Adapters
{
    ...
    {
        internal static ExperienceMenu.Views.IConfiguration ContractToViewAdapter(Start9.Api.Contracts.IConfigurationContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IConfigurationContract ViewToContractAdapter(ExperienceMenu.Views.IConfiguration view)
        {
            if ((view == null))
            {
                return null;
