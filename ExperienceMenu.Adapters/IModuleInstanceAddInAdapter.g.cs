...
namespace ExperienceMenu.Adapters
{
    ...
    {
        internal static ExperienceMenu.Views.IModuleInstance ContractToViewAdapter(Start9.Api.Contracts.IModuleInstanceContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IModuleInstanceContract ViewToContractAdapter(ExperienceMenu.Views.IModuleInstance view)
        {
            if ((view == null))
            {
                return null;
