...
namespace ExperienceMenu.Adapters
{
    ...
    {
        private ExperienceMenu.Views.IModuleAssembly _view;
        public IModuleAssemblyViewToContractAddInAdapter(ExperienceMenu.Views.IModuleAssembly view)
        {
            _view = view;
        }
        public string Name
        ...
        public System.AddIn.Contract.IListContract<Start9.Api.Contracts.IModuleInstanceContract> Instances
        {
            get
            {
                return System.AddIn.Pipeline.CollectionAdapters.ToIListContract<ExperienceMenu.Views.IModuleInstance, Start9.Api.Contracts.IModuleInstanceContract>(_view.Instances, ExperienceMenu.Adapters.IModuleInstanceAddInAdapter.ViewToContractAdapter, ExperienceMenu.Adapters.IModuleInstanceAddInAdapter.ContractToViewAdapter);
            }
        }
        public Start9.Api.Contracts.IConfigurationContract SavedConfiguration
        {
            get
            {
                return ExperienceMenu.Adapters.IConfigurationAddInAdapter.ViewToContractAdapter(_view.SavedConfiguration);
            }
        }
        public Start9.Api.Contracts.IConfigurationContract CurrentConfiguration
        {
            get
            {
                return ExperienceMenu.Adapters.IConfigurationAddInAdapter.ViewToContractAdapter(_view.CurrentConfiguration);
            }
        }
        ...
        {
            _view.Kill(ExperienceMenu.Adapters.IModuleInstanceAddInAdapter.ContractToViewAdapter(instance));
        }
        ...
        internal ExperienceMenu.Views.IModuleAssembly GetSourceView()
        {
            return _view;
        }
    }
