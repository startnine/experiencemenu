...
namespace ExperienceMenu.Adapters
{
    ...
    public class IMessageContractToViewAddInAdapter : ExperienceMenu.Views.IMessage
    {
        ...
        public ExperienceMenu.Views.IMessageEntry MessageEntry
        {
            get
            {
                return ExperienceMenu.Adapters.IMessageEntryAddInAdapter.ContractToViewAdapter(_contract.MessageEntry);
            }
        }
