...
namespace ExperienceMenu.Adapters
{
    ...
    {
        internal static ExperienceMenu.Views.IReceiverEntry ContractToViewAdapter(Start9.Api.Contracts.IReceiverEntryContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IReceiverEntryContract ViewToContractAdapter(ExperienceMenu.Views.IReceiverEntry view)
        {
            if ((view == null))
            {
                return null;
