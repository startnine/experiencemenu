...
namespace ExperienceMenu.Adapters
{
    ...
    {
        internal static ExperienceMenu.Views.IMessage ContractToViewAdapter(Start9.Api.Contracts.IMessageContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IMessageContract ViewToContractAdapter(ExperienceMenu.Views.IMessage view)
        {
            if ((view == null))
            {
                return null;
