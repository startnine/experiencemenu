...
namespace ExperienceMenu.Adapters
{
    ...
    {
        internal static ExperienceMenu.Views.IHost ContractToViewAdapter(Start9.Api.Contracts.IHostContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IHostContract ViewToContractAdapter(ExperienceMenu.Views.IHost view)
        {
            if ((view == null))
            {
                return null;
