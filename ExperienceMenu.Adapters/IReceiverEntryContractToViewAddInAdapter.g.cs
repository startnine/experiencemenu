...
namespace ExperienceMenu.Adapters
{
    ...
    public class IReceiverEntryContractToViewAddInAdapter : ExperienceMenu.Views.IReceiverEntry
    {
        private Start9.Api.Contracts.IReceiverEntryContract _contract;
        private System.AddIn.Pipeline.ContractHandle _handle;
        private ExperienceMenu.Adapters.IMessageEventHandlerViewToContractAddInAdapter MessageReceived_Handler;
        private static System.Reflection.MethodInfo s_MessageReceivedEventAddFire;
		public event System.EventHandler<ExperienceMenu.Views.MessageReceivedEventArgs>MessageReceived{
			add{
        ...
        private event System.EventHandler<ExperienceMenu.Views.MessageReceivedEventArgs> _MessageReceived;
        ...
        internal virtual void Fire_MessageReceived(ExperienceMenu.Views.MessageReceivedEventArgs args)
        {
            if ((_MessageReceived == null))
            {
            }
